...
De esta manera, los registros quedan


\xmm{1}
\regintOcho{$\floor{\frac{R_{11}\ceil{256v}}{256}}$}
...
Y \xmm{2} de manera analoga. Luego sumamos los registros, lo packeamos en 8 bits y lo guardamos en memoria.
